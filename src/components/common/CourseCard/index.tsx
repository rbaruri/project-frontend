...
const CourseCard: React.FC<CourseCardProps> = ({ course, userId, onClick, onViewModules }) => {
  ...
  return (
    <div className="relative">
      <div 
        className={`bg-white rounded-lg shadow-md p-6 transition-shadow duration-300 ${
      ...
      >
        ...
        <div className="mt-4 flex justify-center">
          <button
            ...
            } text-white rounded-md transition-colors duration-200 flex items-center space-x-2`}
            disabled={!hasStarted}
          >
