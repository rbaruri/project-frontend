...
export const getLoadingComponent = (): React.ReactElement => (
...
export const getErrorComponent = (error: string): React.ReactElement => (
  <div className="text-center p-4 text-red-600 bg-red-50 rounded-lg">
    {error}
  </div>
);

export const getEmptyStateComponent = (): React.ReactElement => (
